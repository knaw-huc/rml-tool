...
import nl.knaw.huc.rmltool.rml.rmldata.builders.TriplesMapBuilder;
...
public class RmlMapperTest {
  ...
  public void generatesRdfTypeTriplesForSubjectMapsWithRrClass() {
    ...
    List<Quad> result = RmlMappingDocument.rmlMappingDocument()
    ...
    MatcherAssert.assertThat(result, Matchers.contains(TripleMatcher.likeTriple(
      TripleMatcher.ANY,
  ...
  public void generatesSubjectsForEachInputObject() {
    ...
    MatcherAssert.assertThat(result, Matchers.contains(
      TripleMatcher.likeTriple(uri("http://www.example.org/example/1"), TripleMatcher.ANY, TripleMatcher.ANY),
      TripleMatcher.likeTriple(uri("http://www.example.org/example/2"), TripleMatcher.ANY, TripleMatcher.ANY)
    ));
  }
  ...
  public void generatesPredicateForEachInputObject() {
    ...
    MatcherAssert.assertThat(result, Matchers.contains(
      TripleMatcher.likeTriple(TripleMatcher.ANY, uri(theNamePredicate), literal("Bill")))
    );
  }
  ...
  public void handlesTemplateMaps() {
    ...
    MatcherAssert.assertThat(result, Matchers.contains(
      TripleMatcher.likeTriple(uri("http://example.org/items/Bill?blah"), TripleMatcher.ANY, TripleMatcher.ANY)
    ));
  }
  ...
  public void canGenerateLinks() {
    ...
    RmlMappingDocument rmlMappingDocument = RmlMappingDocument.rmlMappingDocument()
  ...
  public void whenALinkToAnOtherObjectIsNotAvailableTheExceptionIsRegistered() {
    ...
    final List<Quad> collect = RmlMappingDocument.rmlMappingDocument()
                                                 .withTripleMap("http://example.org/personsMap", makePersonMap(theNamePredicate))
                                                 .withTripleMap("http://example.org/documentsMap", makeDocumentMap(theWrittenByPredicate))
                                                 .build(logicalSource -> {
